...
{
    /// <summary>
    /// Small helper to build and tear down a minimal planet scene for PlayMode tests.
    /// Creates a planet root, a Camera with CameraController, and a PlanetTileVisibilityManager
    /// wired to the camera and planet.
    /// </summary>
    public class PlaymodeTestSceneBuilder
    {
        ...
        public void Build()
        {
            ...
            // Provide a minimal TerrainConfig asset instance
